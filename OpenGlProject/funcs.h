...
void LoadObjectAndTex(const char* filename, float x1, float x2, float x3, float x4, float y1, float y2, float y3, float y4, const char* name, bool hitbox, float size = 0.0f, bool isSolid = true);
void LoadMainScene();
void LoadMenuScene();
void LoadObjectFromMem(const char* texname, float x1, float x2, float x3, float x4, float y1, float y2, float y3, float y4, const char* name, bool hitbox, float size = 0.0f, bool isSolid = true);
